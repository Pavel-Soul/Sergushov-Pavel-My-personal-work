...
graphic_filenames[gr_fire] = ["bullet.png", 16]
...
def file_images():
    ...
    for i in range(gr_total):
        imagelist.append(
            pygame.transform.flip(imagelist[i], True, False)
