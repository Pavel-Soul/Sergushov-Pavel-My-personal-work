...
level_2.set_hero(50, 450)
level_2.min_x = 0
level_2.max_x = win_width * 15

level_2.add_enemy(1, 400, 400, 30, 900, 4)
level_2.add_enemy(1, 450, 400, 30, 900, 4)
level_2.add_enemy(1, 500, 400, 30, 900, 4)

level_2.add_platform(0, 400, 100, 50, 3, 0, 0)
level_2.add_platform(200, 350, 100, 50, 3, 0, 0)
level_2.add_platform(400, 300, 100, 50, 3, 0, 0)
